...
const userRoutes = require('./routes/user.routes'); // Only declare once
...
// routes
app.use('/api/v1/user', userRoutes); // Use the declared userRoutes
...
app.use('/api/v1/login', userRoutes); // Use the declared userRoutes
